        ...
        <v-sheet color="grey lighten-3" height="280">
          <v-row align="center" justify="center" class="fill-height">
            <v-col class="pa-3" cols="6" md="3">
              <div color="grey lighten-3" align="center" justify="center" width="420">
                <h1>회원가입</h1>
              </div>
            </v-col>
          </v-row>
        ...
        <v-col cols="12" md="12">
          <v-sheet height="360">
            ...
            <v-row>
              ...
              <v-col class="d-flex" cols="12" sm="3">
                <v-row>
                  <v-text-field label="비밀번호를 입력하세요." solo dense v-model="passwd" type="password"></v-text-field>
                </v-row>
              </v-col>
            </v-row>
            <!--생일 정보-->
                ...
                <v-row>
                  <v-menu v-model="menu2" :close-on-content-click="false" :nudge-right="40"
                    ...
                    <template v-slot:activator="{ on, attrs }">
                      <v-text-field label="생년 월일을 입력하세요." solo dense v-model="birthday" prepend-icon="mdi-calendar"
            ...
            <v-row>
              ...
              <v-col class="d-flex" cols="12" sm="3">
                <v-row>
                  <v-text-field @click="execDaumPostcode()" label="우편번호를 입력하세요." solo dense v-model="zipcode"></v-text-field>
                </v-row>
              </v-col>
            </v-row>
            ...
            <v-row>
              ...
              <v-col class="d-flex" cols="12" sm="3">
                <v-row>
                  <v-text-field label="주소를 입력하세요." solo dense v-model="addr"></v-text-field>
                </v-row>
              </v-col>
            </v-row>
            <v-row>
              ...
              <v-col class="d-flex" cols="12" sm="3">
                <v-row>
                  <v-text-field label="상세 주소를 입력하세요." solo dense v-model="addr_detail"></v-text-field>
                </v-row>
              </v-col>
            </v-row>
            <!--핸드폰 번호-->
          ...
          <v-col cols="12" md="12">
            <div class="pa-12" justify="center" align="center">
              <v-btn color="primary" @click="addNewUser()"> 회원가입</v-btn>
              <!-- <v-alert
              dense
              type="success"
              v-model="alert"
